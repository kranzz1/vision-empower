//Vision Empower Glove Code - Version 1.5.1
...
// Read the value from the photosensor, determine duty cycle, and use analogWrite to implement PWM  
  delay(10);
  Serial.println(dutyCycle); //send duty cycle to serial out pin
  analogWrite(motorPin1, dutyCycle); //use analogWrite function to implement PWM
} //end of Start_Motor
